...
| DisconnectReason | int |  |  |  | PBX disconnect reason. Values:<br/>129 — transfer<br/>16 — normal clearing<br/>17 — busy<br/>Others — ISDN codes. 0 if forwarded. |
| DisconnectSource | int |  |  |  | Disconnect source:<br/>0 — Unknown<br/>1 — Calling party<br/>2 — Called party<br/>3 — PBX. 1 if forwarded, 2 if transferred. |
...
| AcSource | int | YES |  | null | Autocall source:<br/>0 — SDK<br/>1 — Predictive Dialer<br/>≥1000 — custom. Null for simple calls. |
...
| MediaType | int |  |  | 0 | Media type:<br/>0 — call<br/>1 — live chat<br/>2 — task |
